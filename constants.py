...
COURSE_SEARCH = "https://{portal_name}.udemy.com/api-2.0/users/me/subscribed-courses?fields[course]=id,url,title,published_title&page=1&page_size={page_size}&search={course_name}"
...
CURRICULUM_ITEMS_PARAMS = {
    ...
    "caching_intent": True,
    "page_size": os.getenv("UDEMY_CURRICULUM_PAGE_SIZE", "200"),
}
